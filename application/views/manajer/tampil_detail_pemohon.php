      ...
      <table width="700" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <div class="form-group">
            <td width="300">ID Pemohon : </td>
            <td width="90" colspan="2">
              <input type="text" name="nama_pemohon" id="id_pemohon" class="form-control" value="<?php echo "$row->id_pemohon"; ?>" readonly>
            </td>
            <td width="90">&nbsp;</td>
            <td width="90">&nbsp;</td>
          </div>
        ...
        <tr>
          <div class="form-group">
            <td>No. Akad : </td>
            <td colspan="2">
              <input type="text" name="no_akad" class="form-control" placeholder="010" disabled value="<?php echo "$row->no_akad"; ?>"/>
            </td>
            <td>&nbsp;&nbsp;Base Anggota : </td>
            <td>
              <input name="base_anggota" type="text" class="form-control" placeholder="&nbsp;" value="<?php echo "$row->base_anggota"; ?>" disabled/>
            </td>
            <td>&nbsp;</td>
          </div>
        </tr>
        ...
        <div calss="form-group">
          <tr>                        
            <td>Alamat Rumah Sesuai Identitas : </td>
            <td colspan="4">
              <input type="text" class="form-control" name="alamat1" id="alamat1" value="<?php echo "$row->alamat1"; ?>">
            </td>
            <td>&nbsp;</td>
          </tr>
          <tr class="tr2"></tr>
          <tr>
            ...
            <td>RT/RW</td>
            <td>
              <input class="form-control" type="text" name="rt/rw1" id="rt/rw1" value="<?php echo "$row->rt_rw1"; ?>"/>
            </td>
            <td>Kelurahan</td>
            <td>
              <input class="form-control" type="text" name="kelurahan1" id="kelurahan1" value="<?php echo "$row->kelurahan1"; ?>"/>
            </td>
          </tr>
          <tr class="tr2"></tr>
          <tr>
            ...
            <td>Kecamatan</td>
            <td colspan="2">
              <input type="text" class="form-control" name="kecamatan1" id="kec1" value="<?php echo "$row->kecamatan1"; ?>"/>
            </td>
            <td>&nbsp;</td>
          </tr>
          <tr class="tr2"></tr>
          <tr>
            <td>&nbsp;</td>
            <td>Kota</td>
            <td><input type="text" class="form-control" name="kota1" id="kota1" value="<?php echo "$row->kota1"; ?>"/></td>
            <td>Kode Pos </td>
            <td>
              <input type="text" class="form-control" name="kode_pos1" id="kpos1" value="<?php echo "$row->kode_pos1"; ?>"/>
            </td>
          </tr>
        </div>
        ...
        <div calss="form-group">
          ...
          <tr>
            ...
            <td>RT/RW </td>
            <td>
              <input type="text" class="form-control" name="rt/rw2" id="rt/rw2" value="<?php echo "$row->rt_rw2"; ?>"/>
            </td>
            <td>Kelurahan</td>
            <td>
              <input type="text" class="form-control" name="kelurahan2" id="kelurahan2" value="<?php echo "$row->kelurahan2"; ?>"/>
            </td>
          </tr>
          <tr class="tr2"></tr>
          <tr>
            ...
            <td>Kecamatan</td>
            <td>
              <input type="text" class="form-control" name="kecamatan2" id="kec2" value="<?php echo "$row->kecamatan2"; ?>"/>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td>Kota</td>
            <td>
              <input type="text" class="form-control" name="kota2" id="kota2" value="<?php echo "$row->kota2"; ?>"/>
            </td>
            <td>Kode Pos </td>
            <td>
              <input type="text" class="form-control" name="kode_pos2" id="kpos2" value="<?php echo "$row->kode_pos2"; ?>"/>
            </td>
          </tr>
        </div>
        <!--end of alamat rumah tinggal-->
        <tr class="tr2"></tr>
        <!--no telp-->
        <div class="form-group">
          <tr>
            ...
            <td>Kantor </td>
            <td>
              <input type="text" class="form-control" name="no_kantor" id="telpkantor" value="<?php echo "$row->no_kantor"; ?>"/>
            </td>
            <td>Rumah </td>
            <td>
              <input type="text" class="form-control" name="no_rumah" id="telprumah" value="<?php echo "$row->no_rumah"; ?>"/>
            </td>
          </tr>
          <tr class="tr2"></tr>
          <tr>
            ...
            <td>Handphone</td>
            <td>
              <input type="text" class="form-control" name="no_hp" id="nohp" value="<?php echo "$row->no_hp"; ?>"/>
            </td>
            <td>Fax. </td>
            <td>
              <input type="text" class="form-control" name="no_fax" id="fax" value="<?php echo "$row->no_fax"; ?>"/>
            </td>
          </tr>
        </div>
        <!--end of no.telp-->
        ...
        <div class="form-group">
          <tr>
            ...
            <td>Nama</td>
            <td colspan="3">
              <input type="text" class="form-control" name="nama_wali" id="namawali" value="<?php echo "$row->nama_wali"; ?>"/>
            </td>
          </tr>
          <tr class="tr2"></tr>
          <tr>
            ...
            <td>Alamat</td>
            <td colspan="3">
              <input type="text" class="form-control" name="alamat_wali" id="alamatwali" value="<?php echo "$row->alamat_wali"; ?>"/>
            </td>
          </tr>
          <tr class="tr2"></tr>
          <tr>
            ...
            <td>No. Telp</td>
            <td>
              <input type="text" class="form-control" name="no_telp_wali" id="telpwali" value="<?php echo "$row->no_telp_wali"; ?>"/>
            </td>
            <td>Hubungan</td>
            <td>
              <input type="text" class="form-control" name="hubungan_wali" id="hubdgnwali" value="<?php echo "$row->hubungan_wali"; ?>"/>
            </td>
          </tr>
        </div>
