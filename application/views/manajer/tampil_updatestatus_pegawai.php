...
<!--form start-->
<form role="form" action="<?php echo base_url();?>c_manajer/update_stat_pegawai" method="post">
  <div class="container">
    <div class="box-body">
      <center>
      <table  border="0" cellpadding="0" cellspacing="0">
        <?php
        foreach ($tampil_daftar_pegawai as $row) {
          ?>
        <!--id pegawai-->
        <tr>
        ...
        <tr>
          <div class="form-group">
            ...
            <td width="90" colspan="2">
              <select class="form-control" name="jenis_identitas" value="<?php echo"$row->jenis_identitas"; ?>">
        ...
        <tr>
          <div class="form-group">
            <td>No. Identitas : </td>
            <td width="90" colspan="2">
              <input type="text" name="no_identitas" id="no_identitas" value="<?php echo"$row->no_identitas"; ?>" class="form-control">
            </td>
          </div>
        </tr>
        <!--end of jenis identitas-->
        ...
        <tr>
          <div class="form-group">
            ...
            <td colspan="3">
              <div class="radio">
                <label>
                  <input type="radio" name="jenis_kelamin" id="laki2" value="L" selected/>Laki-Laki&nbsp;&nbsp;&nbsp;
                </label>
                <label>
        ...
        <tr>
          <div class="form-group">
            <td>Tanggal Lahir : </td>
            <td colspan="2">
              <input maxlength="10" name="tgl_lahir" value="<?php echo"$row->tgl_lahir"; ?>" id="tgl_lahir" type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
            </td>
          </div>
        </tr>
        ...
        <tr>
          <div calss="form-group">                        
            <td>Tempat Lahir : </td>
            <td colspan="4">
              <input name="tempat_lahir" id="tempat lahir" value="<?php echo"$row->tempat_lahir"; ?>" type="text" class="form-control">
            </td>
          </div>
        </tr>
        <!--end of tempat lahir-->
        ...
        <div calss="form-group">
          <tr>                        
            ...
            <td colspan="4">
              <input name="alamat_lengkap" id="alamat_lengkap" value="<?php echo"$row->alamat_lengkap"; ?>" type="text" class="form-control">
            </td>
          </tr>
        </div>
        ...
        <div calss="form-group">
          <tr>                        
            ...
            <td colspan="4">
              <input name="no_telp" id="no_telp" value="<?php echo"$row->no_telp"; ?>" type="text" class="form-control">
            </td>
          </tr>
        </div>
        <!--end of no telp-->
