<div class="box-header">
  <h3><u><center>Tambah Data Anggota</center></u></h3>
</div><!--/.box-header-->
<!--form start-->
<form role="form" action="<?php echo base_url();?>c_cs/input_anggota" method="post">
  <div class="container">
    <div class="box-body">
      <center>
              ...
              <tr>
                <td><table border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <div class="form-group">
                      <td width="50" >Nama: </td>
                      <td width="90"><input type="text" name="nama_anggota" id="nama_anggota" class="form-control"></td>
                    </div>
                  </tr>
                  <!--end of nama pemohon-->
                  <tr class="tr2"></tr>
